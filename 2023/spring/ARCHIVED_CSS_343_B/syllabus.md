...
**Class** : M/W 11:00-1:00. DISC 162[](https://washington.zoom.us/j/95014364371?pwd=T0FBdU53K2VSbTdrWG1kdVpvZHhoZz09)

**Office Hours** : Monday 1-2pm and Thursday 10:45-11:45am in UW1-260Q. Signup via [Canvas Calendar](https://canvas.uw.edu/calendar)
...
**Assignment Submission:** Exercises will be graded as Complete/Incomplete. Your 2 lowest exercise grades will automatically be dropped in Canvas.
...
**Course Material:** Lecture notes and other material will be posted to Canvas under "Files". See [List of Topics](https://canvas.uw.edu/courses/1647764/pages/topics) for detailed list of topics and additional references.
...
---|---|---  
Week-1 | Introduction, C++ Review | Multiple exercises due (email, discord, unix, github, ...)  
Week-2 | Trees | **SVG Project**  
Week-3 | Graphs | **BST Project**  
Week-4 | N-ary Trees |   
Week-5 | Design Patterns | **Graph Project**  
Week-6 | Review  
**Midterm - 3 May** |   
Week-7 | Hash Table | **LeetCode Project**  
Week-8 | Polymorphism |   
Week-9 | Theory of Computation | **Movies Design Project**  
Week-10 | Turing Machine | **Memorial Day - No class  
Movies Project**  
Finals Week | **Final - 5 June** | No classes during finals week  
